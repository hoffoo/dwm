...
license=('MIT')
options=(zipman)
depends=('libx11' 'libxinerama' 'libxft' 'terminus-font' 'gnu-free-fonts' 'rxvt-unicode' 'dmenu' 'xscreensaver' 'acpi' 'dunst' 'bash-completion' 'encfs' 'synaptics' 'alsa-utils' 'pkg-config' 'pulseaudio' 'pulseaudio-alsa' 'pavucontrol' 'conky' 'openvpn' 'spotify' 'scrot' 'feh' 'thunar')
provides=('dwm')
conflicts=('dwm')
epoch=1
